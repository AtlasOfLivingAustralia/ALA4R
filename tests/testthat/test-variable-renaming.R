...
thischeck=function() {
    test_that("particular variables are renamed for occurrence data", {
        skip_on_cran()
        temp=c("scientificName - original","matchedScientificName","recordID","xVersion","MatchTaxonConceptGUID","vernacularName","taxonRank","matchedsomething","processedsomething","parsedsomething")
