...
-->
<!-- Knit this vignette to HTML and PDF manually: -->
<!-- rmarkdown::render(system.file("vignettes/ALA4R.Rmd"),package="ALA4R"),output_format = "html_vignette") -->
<!-- rmarkdown::render(system.file("vignettes/ALA4R.Rmd"),package="ALA4R"),output_format = "pdf_document") -->
<!-- then use tools::compactPDF(system.file("vignettes/ALA4R.pdf",package="ALA4R"),gs_quality="ebook")-->
<!-- The vignette is not built automatically as part of the package because of all of the additional -->
<!-- packages required here. -->
