...
<!-- It is not built automatically as part of the package because of all of the additional -->
...
imfiles <- sapply(s,function(z){ 
  ifelse(!is.na(z$thumbnailUrl),ALA4R:::cached_get(z$thumbnailUrl,type="binary_filename"),"") 
})
```
