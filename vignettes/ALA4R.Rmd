...
First download an example shapefile of South Australian conservation reserve boundaries: see https://data.sa.gov.au/dataset/conservation-reserve-boundaries. We use the ALA4R's caching mechanism here, but you could equally download this file directly.
