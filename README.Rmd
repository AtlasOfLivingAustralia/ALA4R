...
**NOTE:** ALA4R is no longer being actively developed. A new package to replace ALA4R, `galah`, is now [available on GitHub](https://github.com/AtlasOfLivingAustralia/galah), and will shortly be on CRAN. `galah` provides an improved interface to ALA data, while providing the same core functionality as ALA4R. For an introduction to `galah`, visit
