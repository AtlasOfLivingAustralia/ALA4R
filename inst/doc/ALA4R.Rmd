...
-->
<!-- To build this vignette, open this file in RStudio and knit to HTML, then move the HTML file to the vignettes directory -->
...
```{r message=FALSE}
tx=taxinfo_download("family:SPHENISCIDAE")
```
